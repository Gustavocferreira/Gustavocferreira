...
- Prototipação e Design Systems no Figma
- Manutenção e evolução do SAPL (PHP/Laravel + PostgreSQL)
- Interfaces públicas acessíveis e conformes à LGPD
...
> Disponível para oportunidades full-time ou projetos remotos.
